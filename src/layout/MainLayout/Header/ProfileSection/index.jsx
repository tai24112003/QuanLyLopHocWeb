  ...
  return (
    <>
      <Chip
        ...
        icon={<Typography p={1}>{user?.name?.toUpperCase()}</Typography>}
                    ...
                    <Box sx={{ p: 2, pt: 0 }}>
                      ...
                      >
                        <ListItemButton
                          ...
                          onClick={(event) => handleListItemClick(event, 0, 'my-account')}
                        >
                          <ListItemIcon>
                            <IconSettings stroke={1.5} size="1.3rem" />
                          </ListItemIcon>
                          <ListItemText primary={<Typography variant="body2">Tài khoản của tôi</Typography>} />
                        </ListItemButton>
                        <ListItemButton
                          sx={{ borderRadius: `${customization.borderRadius}px` }}
