...
import { runAddCommonQuestion, runUpdateCommonQuestion } from 'api/question';
              ...
              <Grid item xs={1.6} margin="0px 20px">
                {isEdit ? (
                  <>
                    ...
                    {question.canRemove && (
                      <Button disabled sx={{ marginLeft: 0.5 }} onClick={null} variant="contained" color="error">
                        Xóa
                      </Button>
                    )}
                  </>
                  ...
                  <>
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={6}>
                        <Button disabled={!question.canRemove} sx={{ width: '100%' }} onClick={onCopy} variant="contained" color="error">
                          Xóa
                        </Button>
                      </Grid>
                    </Grid>
