          ...
          <Accordion ref={thisRef} sx={{ marginBottom:3}}>
            ...
            <Grid item xs={12} sx={{marginBottom:1.5,marginTop: 3}}>
              ...
              <Grid item xs={10}>
                ...
                {isExit? 
                  (<Button onClick={deleteInExam} color='error' variant='contained' >Xóa khỏi đề</Button>):
                  (<Button onClick={addIntoExam} variant='contained' >Thêm vào đề</Button>)}
                </Grid>
            ...
            <Grid container spacing={gridSpacing}>
              ...
              {question?.questions?.map((questionItem, index)=>(
                <React.Fragment key={index}>
                  <QuestionItem infoExam={infoExam} parentQuestion={question} subjects={subjects} onDestroy={onDestroy} question={questionItem} lenght={question?.questions}/>
                </React.Fragment>
              ))}
                <Grid item xs={12}>
